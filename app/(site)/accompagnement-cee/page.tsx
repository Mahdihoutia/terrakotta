      ...
      <section className="bg-[#FAF8F5] py-20 md:py-28">
        <div className="mx-auto max-w-[1400px] px-6 md:px-10 lg:px-16">
          ...
          <motion.h2
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="font-display mb-6 text-3xl font-bold text-[#0D1B35] md:text-4xl"
          >
            Combien rapportent les CEE&nbsp;?
          </motion.h2>
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            ...
            >
              <p>
                La prime énergie CEE que vous percevez est le produit de deux facteurs&nbsp;: le{" "}
                <strong className="font-semibold text-[#0D1B35]">volume de kWh cumac</strong>{" "}
                généré par vos travaux (calculé selon les formules des fiches standardisées) et le{" "}
                <strong className="font-semibold text-[#0D1B35]">prix unitaire</strong> du kWh
                cumac, exprimé en €/MWh cumac. Ce prix varie selon les conditions du marché des
                CEE&nbsp;: historiquement entre 5 et 10&nbsp;€/MWh cumac, il peut fluctuer
                significativement selon l'offre et la demande.
              </p>
              <p>
                Pour optimiser votre prime, il est donc important non seulement de bien
                identifier les fiches les plus valorisables, mais aussi de choisir le bon moment
                et le bon interlocuteur (obligé ou délégataire) pour valoriser vos kWh cumac.
                Notre bureau d'étude CEE vous accompagne pour maximiser la valeur de chaque
                dossier.
              </p>
            </motion.div>
            ...
            >
              <div className="space-y-4">
                {[
                  {
                    label: "Isolation combles — maison individuelle 100 m²",
                    kwh: "~35 000 kWh cumac",
                    prime: "~250–350 €",
                    fiche: "BAR-EN-101",
                  },
                  {
                    label: "PAC air/eau — maison individuelle",
                    kwh: "~80 000 kWh cumac",
                    prime: "~600–800 €",
                    fiche: "BAR-TH-171",
                  },
                  {
                    label: "PAC tertiaire 300 kW",
                    kwh: "~500 000 kWh cumac",
                    prime: "~3 500–5 000 €",
                    fiche: "BAT-TH-163",
                  },
                ].map((ex, i) => (
                  <div
                    key={i}
                    className="flex flex-col gap-3 rounded-xl border border-[#DBEAFE] bg-white px-5 py-4 shadow-sm sm:flex-row sm:items-center sm:justify-between"
                  >
                    <div>
                      <p className="font-display text-[0.95rem] font-semibold text-[#0D1B35]">
                        {ex.label}
                      </p>
                      <p className="mt-0.5 font-mono text-[0.72rem] text-[#2563EB]">{ex.fiche}</p>
                    </div>
                    <div className="flex shrink-0 flex-col items-end gap-1 text-right">
                      <span className="text-[0.8rem] text-[#4A6285]">{ex.kwh}</span>
                      <span className="rounded-full bg-[#EFF6FF] px-3 py-0.5 font-semibold text-[#2563EB] text-[0.82rem]">
                        {ex.prime}
                      </span>
                    </div>
                  </div>
                ))}
                <p className="text-[0.75rem] leading-relaxed text-[#4A6285]">
                  * Estimations indicatives calculées sur la base d'un prix de 7&nbsp;€/MWh cumac.
                  Les montants réels dépendent des conditions de marché et des paramètres
