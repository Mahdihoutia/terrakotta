...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.kilowater.fr/bureau-d-etude-renovation-energetique",
    images: [
      {
        url: "https://www.kilowater.fr/opengraph-image",
        width: 1200,
        height: 630,
  ...
  alternates: {
    canonical: "https://www.kilowater.fr/bureau-d-etude-renovation-energetique",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Accueil", item: "https://www.kilowater.fr" },
    {
      ...
      item: "https://www.kilowater.fr/bureau-d-etude-renovation-energetique",
    },
  ],
};
